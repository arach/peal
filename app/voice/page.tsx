...
import { Download, Copy, Trash2, FileAudio, Zap } from "lucide-react"
...
export default function TTSStudio() {
  ...
  const voiceActions = (
    <>
      <Badge className="bg-blue-500/10 text-blue-400 border-blue-500/20 text-xs font-light px-2 py-0.5">
        OpenAI & Groq
      </Badge>
      <div className="text-xs text-gray-400 font-mono">{generatedAudios.length} files generated</div>
    </>
  )
  ...
  return (
    <>
      <StudioHeader 
        currentTool="voice"
        title="Voice Lab"
        subtitle="Text-to-speech generation"
            ...
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 border border-gray-800/50 rounded-sm backdrop-blur-sm">
              {generatedAudios.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-sm text-gray-500 font-light">No files generated</p>
                </div>
              ) : (
