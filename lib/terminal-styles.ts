...
export const terminalStyles = {
  ...
  components: {
    ...
    button: {
      primary: 'relative inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-b from-sky-500 to-sky-600 text-white font-mono text-xs uppercase tracking-wider rounded-sm shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2),0_2px_0_rgba(0,0,0,0.2)] hover:from-sky-400 hover:to-sky-500 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.3),0_3px_0_rgba(0,0,0,0.3)] active:from-sky-600 active:to-sky-700 active:shadow-[inset_0_3px_8px_0_rgba(0,0,0,0.3),0_1px_0_rgba(0,0,0,0.2)] transition-all duration-150 transform hover:-translate-y-[1px] active:translate-y-[1px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none disabled:active:transform-none',
      
      secondary: 'relative inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-b from-gray-800 to-gray-900 border border-gray-700 text-gray-200 font-mono text-xs uppercase tracking-wider rounded-sm shadow-[0_2px_0_rgba(0,0,0,0.5),inset_0_1px_0_0_rgba(255,255,255,0.05)] hover:from-gray-750 hover:to-gray-850 hover:border-gray-600 hover:text-gray-100 hover:shadow-[0_3px_0_rgba(0,0,0,0.5),inset_0_1px_0_0_rgba(255,255,255,0.08)] active:shadow-[inset_0_2px_6px_0_rgba(0,0,0,0.5),0_1px_0_rgba(0,0,0,0.5)] active:from-gray-850 active:to-gray-900 transition-all duration-150 transform hover:-translate-y-[1px] active:translate-y-[1px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none disabled:active:transform-none',
      
      ghost: 'relative inline-flex items-center justify-center px-6 py-2.5 text-gray-400 font-mono text-xs uppercase tracking-wider rounded-sm hover:text-gray-200 hover:bg-gray-800/30 hover:shadow-[0_0_0_1px_rgba(107,114,128,0.3)] active:bg-gray-900/60 active:text-gray-100 active:shadow-[inset_0_2px_4px_0_rgba(0,0,0,0.4)] active:translate-y-[1px] transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:transform-none',
      
      danger: 'relative inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-b from-red-900/20 to-red-950/30 border border-red-500/50 text-red-400 font-mono text-xs uppercase tracking-wider rounded-sm shadow-[0_2px_0_rgba(127,29,29,0.3),inset_0_1px_0_0_rgba(239,68,68,0.1)] hover:from-red-900/30 hover:to-red-950/40 hover:border-red-500 hover:text-red-300 hover:shadow-[0_3px_0_rgba(127,29,29,0.4),0_0_20px_rgba(239,68,68,0.15)] active:shadow-[inset_0_2px_6px_0_rgba(0,0,0,0.3),0_1px_0_rgba(127,29,29,0.3)] active:from-red-950/40 active:to-red-900/30 transition-all duration-150 transform hover:-translate-y-[1px] active:translate-y-[1px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none disabled:active:transform-none',
      
      success: 'relative inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-b from-emerald-900/20 to-emerald-950/30 border border-emerald-500/50 text-emerald-400 font-mono text-xs uppercase tracking-wider rounded-sm shadow-[0_2px_0_rgba(6,78,59,0.3),inset_0_1px_0_0_rgba(16,185,129,0.1)] hover:from-emerald-900/30 hover:to-emerald-950/40 hover:border-emerald-500 hover:text-emerald-300 hover:shadow-[0_3px_0_rgba(6,78,59,0.4),0_0_20px_rgba(16,185,129,0.15)] active:shadow-[inset_0_2px_6px_0_rgba(0,0,0,0.3),0_1px_0_rgba(6,78,59,0.3)] active:from-emerald-950/40 active:to-emerald-900/30 transition-all duration-150 transform hover:-translate-y-[1px] active:translate-y-[1px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none disabled:active:transform-none',
      
      icon: 'relative inline-flex items-center justify-center p-2 bg-gradient-to-b from-gray-800 to-gray-900 border border-gray-700 text-gray-400 rounded-sm shadow-[0_2px_0_rgba(0,0,0,0.5),inset_0_1px_0_0_rgba(255,255,255,0.05)] hover:from-gray-750 hover:to-gray-850 hover:border-gray-600 hover:text-gray-200 hover:shadow-[0_3px_0_rgba(0,0,0,0.5)] active:shadow-[inset_0_2px_4px_0_rgba(0,0,0,0.5),0_1px_0_rgba(0,0,0,0.5)] active:from-gray-850 active:to-gray-900 transition-all duration-150 transform hover:-translate-y-[1px] active:translate-y-[1px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none disabled:active:transform-none',
      
      warning: 'relative inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-b from-amber-900/20 to-amber-950/30 border border-amber-500/50 text-amber-400 font-mono text-xs uppercase tracking-wider rounded-sm shadow-[0_2px_0_rgba(120,53,15,0.3),inset_0_1px_0_0_rgba(251,146,60,0.1)] hover:from-amber-900/30 hover:to-amber-950/40 hover:border-amber-500 hover:text-amber-300 hover:shadow-[0_3px_0_rgba(120,53,15,0.4),0_0_20px_rgba(251,146,60,0.15)] active:shadow-[inset_0_2px_6px_0_rgba(0,0,0,0.3),0_1px_0_rgba(120,53,15,0.3)] active:from-amber-950/40 active:to-amber-900/30 transition-all duration-150 transform hover:-translate-y-[1px] active:translate-y-[1px] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:transform-none disabled:active:transform-none',
    },
